...
typedef struct {
    int32_t row;  /* SUSPECT-PATCH: widened from int16_t for >32767-line documents */
    int32_t col;  /* SUSPECT-PATCH: widened from int16_t for >32767-line documents */
    int32_t blk_imp_row;  /* SUSPECT-PATCH: widened from int16_t for >32767-line documents */
    int32_t blk_imp_col;  /* SUSPECT-PATCH: widened from int16_t for >32767-line documents */
    int32_t blk_imp_tab;  /* SUSPECT-PATCH: widened from int16_t for >32767-line documents */
    Array(int16_t) ind_typ_stk;
    Array(int16_t) ind_len_stk;

    // temp
    int32_t end_row;  /* SUSPECT-PATCH: widened from int16_t for >32767-line documents */
    int32_t end_col;  /* SUSPECT-PATCH: widened from int16_t for >32767-line documents */
    int32_t cur_row;  /* SUSPECT-PATCH: widened from int16_t for >32767-line documents */
    int32_t cur_col;  /* SUSPECT-PATCH: widened from int16_t for >32767-line documents */
    int32_t cur_chr;
    int8_t sch_stt;
...
static unsigned serialize(Scanner *scanner, char *buffer) {
    ...
    *(int32_t *)&buffer[size] = scanner->row;
    size += sizeof(int32_t);
    *(int32_t *)&buffer[size] = scanner->col;
    size += sizeof(int32_t);
    *(int32_t *)&buffer[size] = scanner->blk_imp_row;
    size += sizeof(int32_t);
    *(int32_t *)&buffer[size] = scanner->blk_imp_col;
    size += sizeof(int32_t);
    *(int32_t *)&buffer[size] = scanner->blk_imp_tab;
    size += sizeof(int32_t);
...
static void deserialize(Scanner *scanner, const char *buffer, unsigned length) {
    ...
    if (length > 0) {
        ...
        size += sizeof(int32_t);
        scanner->col = *(int32_t *)&buffer[size];
        size += sizeof(int32_t);
        scanner->blk_imp_row = *(int32_t *)&buffer[size];
        size += sizeof(int32_t);
        scanner->blk_imp_col = *(int32_t *)&buffer[size];
        size += sizeof(int32_t);
        scanner->blk_imp_tab = *(int32_t *)&buffer[size];
        size += sizeof(int32_t);
        while (size < length) {
...
static bool scan(Scanner *scanner, TSLexer *lexer, const bool *valid_symbols) {
    ...
    int32_t bgn_row = scanner->cur_row;  /* SUSPECT-PATCH */;
    int32_t bgn_col = scanner->cur_col;  /* SUSPECT-PATCH */
