#!/usr/bin/env python3
"""Loopback HTTP fixture for the generated TypeScript MCP server acceptance test.
...
never routed through a float. A "slow" widget identifier sleeps long enough
for the caller's cancellation and deadline paths to be observed.
"""
